...
public class OCVMinerRunnable implements Runnable {

	private OCVMinerApplication application;
	private WakeLock wakeLock = null;
	private WifiLock wifiLock = null;

	public OCVMinerRunnable(OCVMinerApplication application) {
	...
	public void run() {
		...
		wakeLock = mgr.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.ocvcoin.ocvminer.WakeLock");
		wakeLock.acquire();
		...
		if (mWifi.isConnected()) {
			...
			wifiLock = wm.createWifiLock(WifiManager.WIFI_MODE_FULL , "com.ocvcoin.ocvminer.WifiLock");
			wifiLock.acquire();
		}
	...
	private void _run() {
		...
		if (retval != 0)
			Log.e("OCVMinerRunnable", "Failed to start OCVMiner");
	}
}
