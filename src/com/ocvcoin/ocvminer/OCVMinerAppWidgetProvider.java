...
public class OCVMinerAppWidgetProvider extends AppWidgetProvider {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (extras != null && extras.containsKey("com.ocvcoin.ocvminer.logEntry")) {
			LogEntry entry = intent.getParcelableExtra("com.ocvcoin.ocvminer.logEntry");
			lastEntry = entry;
		}
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        intent.setComponent(new ComponentName("com.ocvcoin.ocvminer",
            "com.ocvcoin.ocvminer.MainActivity"));
        PendingIntent pendingIntent = PendingIntent.getActivity(
            context, 0, intent, 0);

	    // Get all ids
	    ComponentName thisWidget = new ComponentName(context, OCVMinerAppWidgetProvider.class);
