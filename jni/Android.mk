...
ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
	LOCAL_C_INCLUDES += "/opt/android-ndk-r12b/arm/include"
endif

ifeq ($(TARGET_ARCH_ABI),x86)
	LOCAL_C_INCLUDES += "/opt/android-ndk-r12b/x86/include"
endif

ifeq ($(TARGET_ARCH_ABI),arm64-v8a)
	LOCAL_C_INCLUDES += "/opt/android-ndk-r12b/arm64/include"
endif

ifeq ($(TARGET_ARCH_ABI),x86_64)
	LOCAL_C_INCLUDES += "/opt/android-ndk-r12b/x86_64/include"
endif
