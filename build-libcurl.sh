...
export ROOTDIR="/opt/android-ndk-r11c/arm/"
export SYSROOT="${ROOTDIR}/sysroot"
export DROIDTOOLS="${ROOTDIR}/bin/${PLATFORM}"
export DROID_GCC_LIBS="${ROOTDIR}/lib/gcc/${PLATFORM}/4.9/"
...
export ROOTDIR="/opt/android-ndk-r11c/x86/"
export SYSROOT="${ROOTDIR}/sysroot"
export DROIDTOOLS="${ROOTDIR}/bin/${PLATFORM}"
export DROID_GCC_LIBS="${ROOTDIR}/lib/gcc/${PLATFORM}/4.9/"
...
export ROOTDIR="/opt/android-ndk-r11c/arm64/"
export SYSROOT="${ROOTDIR}/sysroot"
export DROIDTOOLS="${ROOTDIR}/bin/${PLATFORM}"
export DROID_GCC_LIBS="${ROOTDIR}/lib/gcc/${PLATFORM}/4.9/"
...
export ROOTDIR="/opt/android-ndk-r11c/x86_64/"
export SYSROOT="${ROOTDIR}/sysroot"
export DROIDTOOLS="${ROOTDIR}/bin/${PLATFORM}"
export DROID_GCC_LIBS="${ROOTDIR}/lib/gcc/${PLATFORM}/4.9/"
