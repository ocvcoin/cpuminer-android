...
###############################################################################
# Begin armv5te compile



export ARCH_TARGET="armv5te-android-linux"
export PLATFORM="arm-linux-androideabi"
export ROOTDIR="/opt/android-ndk-r12b/arm/"
...
export ROOTDIR="/opt/android-ndk-r12b/x86/"
export SYSROOT="${ROOTDIR}/sysroot"
export DROIDTOOLS="${ROOTDIR}/bin/${PLATFORM}"
export DROID_GCC_LIBS="${ROOTDIR}/lib/gcc/${PLATFORM}/4.9.x/"
...
###############################################################################
# Begin arm64-v8a compile



export ARCH_TARGET="aarch64-android-linux"
export PLATFORM="aarch64-linux-android"
export ROOTDIR="/opt/android-ndk-r12b/arm64/"
export SYSROOT="${ROOTDIR}/sysroot"
export DROIDTOOLS="${ROOTDIR}/bin/${PLATFORM}"
export DROID_GCC_LIBS="${ROOTDIR}/lib/gcc/${PLATFORM}/4.9.x/"
